...
\titleformat{\section}{\ttfamily\bfseries\Large}{\thesection}{1em}{}
\titleformat{\subsection}{\ttfamily\bfseries\large}{\thesubsection}{1em}{}
\titleformat{\subsubsection}{\ttfamily\bfseries}{\thesubsubsection}{1em}{}
\titleformat{\paragraph}{\ttfamily\bfseries}{\theparagraph}{1em}{}

\setlength\extrarowheight{8pt}
\newenvironment{formulatable}{%
	\center%
	\tabularx{\textwidth}{>{\hsize = 1.5\hsize\raggedleft\begin{math}}X<{\end{math}} @{{}$ \: = \: ${}} >{\hsize = 0.75\hsize\begin{math}}X<{\end{math}} >{\hsize = 0.75\hsize}X}
}{%
	\endtabularx%
	\endcenter%
}
